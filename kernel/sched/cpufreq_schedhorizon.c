 ...
 *
 * Copyright (C) 2024 KanonifyX
 * Adapt schedhorizon for 4.9: KanonifyX <kanonify01@gmail.com>
 *
...
static unsigned int default_efficient_freq_lp[] = {1420800};
static unsigned int default_efficient_freq_perf[] = {1843200};
